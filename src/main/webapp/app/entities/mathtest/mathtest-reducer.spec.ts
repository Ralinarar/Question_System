...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './mathtest.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MATHTEST_LIST actions', async () => {
    ...
    it('dispatches FETCH_MATHTEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MATHTEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MATHTEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MATHTEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MATHTEST actions', async () => {
      const expectedActions = [
        {
