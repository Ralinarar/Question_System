...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './predicate.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PREDICATE_LIST actions', async () => {
    ...
    it('dispatches FETCH_PREDICATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PREDICATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PREDICATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PREDICATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PREDICATE actions', async () => {
      const expectedActions = [
        {
